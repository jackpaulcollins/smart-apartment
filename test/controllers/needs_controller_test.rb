...
class NeedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create need" do
    assert_difference('Need.count') do
      post needs_url, params: { need: { content: @need.content, quantity: @need.quantity, title: @need.title } }
    end
  ...
  test "should update need" do
    patch need_url(@need), params: { need: { content: @need.content, quantity: @need.quantity, title: @need.title } }
